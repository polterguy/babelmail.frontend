...
import { EditBabelmail_templates_templatesComponent } from './modals/edit.babelmail_templates_templates.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Templates
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-babelmail_templates_templates',
  templateUrl: './babelmail_templates_templates.component.html',
  styleUrls: ['./babelmail_templates_templates.component.scss'],
})
export class Babelmail_templates_templatesComponent
  ...
  implements OnInit
{
   ...
   */
  public url() {
    return 'magic/modules/babelmail/templates/templates';
  }
  ...
  protected read(filter: any) {
    return this.httpService.babelmail_templates_templates.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.babelmail_templates_templates.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.babelmail_templates_templates.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.id = this.createFormControl('templates.templates.id.like');
    this.created = this.createFormControl('templates.templates.created.eq');
    this.content = this.createFormControl('templates.templates.content.eq');
  }
